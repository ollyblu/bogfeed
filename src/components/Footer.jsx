          ...
          <div className="footer-grid">
            ...
            <div className="footer-brand">
              ...
              <div className="social-links">
                <a href="https://www.instagram.com/bogfeed.id" target='blank' className="social-icon" aria-label="Instagram">
                ...
                <a href="https://wa.me/6285865102452" target='blank' className="social-icon" aria-label="WhatsApp">
                ...
                <a href="https://www.facebook.com/bogfeed.id" target='blank' className="social-icon" aria-label="Facebook">
            ...
            <div className="footer-col">
              ...
              <ul className="contact-list">
                ...
                <li>
                  ...
                  {/* GANTI: Email */}
                  <span>bogfeed.id@gmail.com</span>
                </li>
                <li>
                  ...
                  {/* GANTI: Alamat */}
                  <span>Bantul, Yogyakarta, Indonesia</span>
                </li>
              </ul>
            </div>
          </div>
